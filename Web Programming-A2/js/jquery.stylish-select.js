      ...
      var multiSelect = $containerDiv.hasClass('multi-select');
			...
			if ($input.children('optgroup').length == 0)
			{
				$input.children().each(function(i)
				{
					...
					// if it's selected
					if (currentIndex != i) {
            $newUl.append($('<li><a href="JavaScript:void(0);" title="'+title+'">'+option+'</a></li>').data('key', key));
					}else {
					  $newUl.append($('<li><a class="hiLite" href="JavaScript:void(0);" title="'+title+'">'+option+'</a></li>').data('key', key));
					}
			...
			else //optgroup
			{
				$input.children('optgroup').each(function()
				{
					...
					$(this).children().each(function()
					{
						...
						$optGroupList.append($('<li><a href="JavaScript:void(0);" `name="'+option+'">'+option+'</a></li>').data('key',key));
					})
				});
				//cache list items object
