function filter(){
	...
	if (document.getElementById("moviename").value && document.getElementById("movieday").value && document.getElementById("movietime").value)
				{
					var priceSA;
					var priceSP;
					var priceSC;
					...
					var numSA = document.getElementById("samovieseat").value;
					var numSP = document.getElementById("spmovieseat").value;
					var numSC = document.getElementById("scmovieseat").value;
					var numFA = document.getElementById("famovieseat").value;
					var numFC = document.getElementById("fcmovieseat").value;
					var numB1 = document.getElementById("b1movieseat").value;
					var numB2 = document.getElementById("b2movieseat").value;
					var numB3 = document.getElementById("b3movieseat").value;
