    ...
    <div class="container">
        ...
        <div id="bigRect" class="tile tile-super-x tile-large-y fixBigRect">
            <div class="tile-content">
                <div class="carousel" data-role="carousel">
                    <div class="slide">
                        <object data="<?php echo "{$content['RC']['trailer']}";?>" width="630" height="310"></object><br>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="each-col f-right">
                                     <b><h1>movie details</h1></b><br>
                                                                            <div class="each-row">
                                            <div class="col-1"><?php echo "{$content['RC']['summary']}";?> </div>
                                            
                                        </div>
                                                                                                                  <div class="each-row">
                                            <div class="col-1"><img src="<?php echo "{$content['RC']['rating']}";?>"></div>
                                    ...
                                    <div class="each-col f-left">
                                                                                                                  ...
                                                                                                                  <div class="each-row">
                                            <div class="col-1"><?php echo "{$content['RC']['description']['0']}"; ?><br><br>
                                                                <?php echo "{$content['RC']['description']['1']}"; ?><br><br>
                                                                <?php echo "{$content['RC']['description']['2']}"; ?></div>
