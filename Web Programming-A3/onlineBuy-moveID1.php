    ...
    <div class="container">
        ...
        <div id="bigRect" class="tile tile-super-x tile-large-y fixBigRect">
            <div class="tile-content">
                <div class="carousel" data-role="carousel">
                    <div class="slide">
						<object data="<?php echo "{$content['AF']['trailer']}";?>" width="630" height="310"></object><br>
					</div>
                </div>
            </div>
        </div>
      ...
      <div class="movie-info-text" class="tile tile-large-x">                                   
									 ...
									 <b><h1>movie details</h1></b><br>
                                                                         	<div class="each-row">
                                        	<div class="col-1"><?php echo "{$content['AF']['summary']}";?> </div>
                                            
                                        </div>
                                                                                                                  <div class="each-row">
                                        	<div class="col-1"><img src="<?php echo "{$content['AF']['rating']}";?>"></div>
                                    ...
                                    <div class="each-col f-left">
                                                                                                                  ...
                                                                                                                  <div class="each-row">
                                        	<div class="col-1"><?php echo "{$content['AF']['description']['0']}"; ?><br><br>
                                                                <?php echo "{$content['AF']['description']['1']}"; ?><br><br>
                                                                <?php echo "{$content['AF']['description']['2']}"; ?></div>
